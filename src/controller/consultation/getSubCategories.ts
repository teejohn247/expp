...
const getCareSubCategories = async (req: Request , res: Response): Promise<void> => {
    ...
    try {
			...
			const categories = await consultationCareCategories.find({parent: category});
...
export default getCareSubCategories;
