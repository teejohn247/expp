...
const createAdviceCategories = async (req: Request , res: Response): Promise<void> => {
    ...
    try {
        ...
        const { categoryName, parent, image, description } = req.body as CategoryRequestBody;
				...
				const checkCategory = await selfCareCategories.findOne({ categoryName });
       ...
       const category = new selfCareCategories({
					categoryName,
...
export default createAdviceCategories;
